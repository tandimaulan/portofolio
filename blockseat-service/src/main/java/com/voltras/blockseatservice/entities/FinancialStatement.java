...
public class FinancialStatement {
	...
	public FinancialStatement(Double ticketPrice, Double paxPrice, Double totalPrice, Double downPaymentPrice,
			Double nta, Double supplierCommision, Double voltrasMarkup, Double discount, Double saServiceFee,
			Double handlingFee, Double saHandlingFeePortion, Double tax, Double ppnPercent, Double aPercent,
			Double flat, Double bPercent, Double channelDiscount, Double xPercent, Double vat, Double adminFee,
			Double insurance) {
		super();
