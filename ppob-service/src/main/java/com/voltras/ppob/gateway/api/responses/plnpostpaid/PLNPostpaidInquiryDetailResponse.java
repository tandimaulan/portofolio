...
public record PLNPostpaidInquiryDetailResponse(String status, String rc, String rcm, String text, String refnum,
		String subid, String nama, String bulan, String blth, String tagihan, String admin, String total, String tarif,
		...
		String incentive_4, String meterread4, String sunit, String sphone, String trxid) {
}
